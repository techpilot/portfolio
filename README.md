# Stephen Digital Portfolio

![Stephen Digital Portfolio](resume-screenshot.png?raw=true "Stephen Digital Portfolio")

### <a href="https://lucid-bassi-8ec726.netlify.app/">LIVE DEMO</a>

## Resume Starter Pack Description

This portfolio starter pack is made using React. The data on the portfolio is directly linked to a JSON file. Any changes to the portfolio can be made in the JSON file. The changes will then be reflected on to the portfolio.
